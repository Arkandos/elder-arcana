...
Once per round outside of your turn, you may change your facing. However, all enemies in your rear facing (before you change it) may make an [[Encounter Actions#Opportunity Attack|Opportunity Attack]] against you.
## Rally
...
## Actions
During an encounter, the way you can act is limited. You can move a number of meters equal to your Speed called a [[Encounter Actions#Stride|Stride]], but must use it all before or after taking an action (unless splitting movement, see Stride)  
