...
4. Intelligence (INT)  
	1. Analysis, observation. Intelligence improves the potential of your Spells, the area of certain abilities, increases your Weave, and adds to your Magic Defense.
5.  Willpower (WIL)  
...
| \-3       | Gain 6 points |
## Statistics
Statistics are derived from your attributes and cannot be directly improved.  $^+$ means the attribute is only added if its positive
...
| Physical & <br>Magical Armor | (STA$^+$ / 2) +<br>[[Rules/Equipment/index#Armors\|Armor]] | Reduce the damage you take by this amount.                                                                                 |
| Weave pool                   | 3 + INT$^+$<br>                                            | Used to pay for magical abilities. Refreshes every day. You can [[Channel]] to regain Weave faster, but this costs Health. |
| Mythos pool                  | 3 + WIL$^+$                                                | Used to reroll Tests. Refreshes every day. You can only spend 1 Mythos to reroll once per Test.                            |
...
# Tiers
Content like Abilities, Powers, etc have a Tier attached to them. You can always acquire content of Tier 0 and 1. Once you have advanced in [[Echelons|Echelon]], you can acquire higher Tiers.
## Abilities
...
| Between capacity and 150% capacity |     Encumbered     |                              Speed halved, [[Battered]]                               |
