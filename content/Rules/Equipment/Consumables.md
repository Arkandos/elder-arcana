...
Tier 1\.  Cost 200\.  Weight 1.
Major action.
Effect: You lose 1 Recovery to reduce your Wound severity by 1 step.
...
### Phoenix Drops \[Create\] \[Body\] \[Consumable\]
Tier 1. Cost 600. Weight 1.
1 Phase.
...
A creature with no Recoveries left may still regain Health as if they spent a single Recovery. Only one set of Phoenix Drops can be applied per hour to any individual creature.
...
## Barrier Bone \[Transmute\] \[Body\] \[Consumable\] \[Instilled\]
Tier 1. Cost 100. Weight 0.
While instilled, your maximum Health is reduced by 2 and you can use the following reaction:
Reaction
Trigger: You would take damage.
Effect: Reduce the damage by 10. 

# General consumables
## Igneous flares \[Create\] \[Fire\] \[Consumable\]
Tier 1. Cost 25. Weight 1.
Major Action.
Effect: You light the flare by breaking it, which sends it flying up into the sky where it remains as a bright light for several minutes. It begins with a red colour, slowly changing into orange and then yellow before fading.